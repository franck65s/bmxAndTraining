<template>
  <div id="app">
    <v-toolbar fixed="true" class="light-blue accent-3">
      <v-toolbar-title>Boost your roost</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-toolbar-side-icon class="hidden-md-and-up"></v-toolbar-side-icon>
      <v-toolbar-items class="hidden-sm-and-down">
        <v-btn flat>Bmx videos</v-btn>
        <v-btn flat>Spec BMX train</v-btn>
        <v-btn flat>Géneralist train</v-btn>
        <v-btn flat>Shops</v-btn>
