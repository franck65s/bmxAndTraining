  ...
  export default {
    ...
    methods: {
      fetchVideoList: function () {
        // GET /someUrl
        this.$http.get(
          'https://www.googleapis.com/youtube/v3/playlistItems?playlistId=PLbArQr9lNfmIzvbOKCT97mpMdba47t4Oz&key=AIzaSyAJv4n6Z0QSMqtxGwusnuy5Rn-m5vFP9zM&fields=items&part=snippet&maxResults=15'
        ).then(response => {
